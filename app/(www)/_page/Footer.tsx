    ...
    return (
        <div className="">
            ...
            <div className="flex justify-center bg-base-100 ">
                <footer className="footer sm:footer-horizontal max-w-7xl p-6 lg:p-8  text-base-content">
                    ...
                    <nav>
                        ...
                        <Link href={`/about_company`} prefetch={false} className="link link-hover " >{t("about_company")}</Link>
            ...
            <div className="flex justify-center bg-base-100 text-base-content border-base-300 ">
                <div className=" footer max-w-7xl px-6 lg:px-8 py-4">
                    <div className="place-self-start md:place-self-center text-base-content/70 flex flex-col md:flex-row gap-2">
                        <p className="flex flex-col gap-1 md:flex-row"><span> © 2025 Coolha Limited All Rights Reserved.</span></p>
                    </div>
                </div>
            </div >
