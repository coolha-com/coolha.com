...
export default function page() {
    ...
    if (sesssion && sesssion.type === SessionType.WithProfile) {
        ...
        return (
            <div className="flex flex-wrap flex-col justify-center mx-auto max-w-3xl">
                {loading && <LoadingSpinner />}
                {data?.map((pub, idx) => (
                    <div className=" bg-base-100 w-dvw md:w-full mx-auto md:max-w-3xl p-4 py-2 mt-2" key={`${pub.id}-${idx}`}>
