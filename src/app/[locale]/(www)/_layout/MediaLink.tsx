...
export default function MediaLink() {
  ...
  return (
    <>
      ...
      <MLink href="https://mp.weixin.qq.com/s/ou6OinQvb0odJswnO2A5Dg" >
        <RiWechatFill className="w-9 h-9 text-base-content" />
      </MLink>

      <MLink href="https://x.com/coolha_com" >
        <RiTwitterXFill className="w-9 h-9 text-base-content" />
      </MLink>
 ...
 {/*      <MLink href="https://farcaster.xyz/coolha" >
      ...
      {/*     <MLink href="https://www.instagram.com/coolha_limited/" >
